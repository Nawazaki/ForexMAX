...
const primaryLinks = [["Markets", "/markets"], ["Macro", "/macro"], ["Research", "/articles"], ["Risk", "/risk-intelligence"], ["Prop Firms", "/prop-firm-comparison"], ["Tools", "/tools"], ["Education", "/education"], ["Sources", "/sources"]] as const;
